...
import { AppLayout, PageHeader, useLayout } from "@/components/AppLayout";
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <div className={`border-t border-border bg-background/80 backdrop-blur-lg ${isMobile ? "p-3" : "p-4"}`}>
          <form onSubmit={handleSubmit} className="max-w-3xl mx-auto flex items-end gap-3">
            ...
            <Button type="submit" size="icon" disabled={!input.trim() || isLoading} className="h-12 w-12 rounded-xl bg-primary hover:bg-primary/90 flex-shrink-0">
...
const Assistant = () => (
  <AppLayout mainClassName="flex flex-col">
    <AssistantContent />
  </AppLayout>
);
