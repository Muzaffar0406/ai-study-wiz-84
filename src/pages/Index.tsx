...
import { fetchTasks, toggleTaskCompleted, deleteTask, fetchTodayStudyStats, fetchStudyStreak } from "@/lib/database";
...
const IndexContent = () => {
  const { user, isMobile, displayName, openChat } = useLayout();
      ...
      <div className={`space-y-6 ${isMobile ? 'p-4' : 'p-8 space-y-8'}`}>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <QuickActionButton icon={Bot} label="Ask AI Assistant" onClick={openChat} variant="success" />
          </div>
        </div>
